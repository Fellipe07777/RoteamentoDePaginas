...
export function Novela() {
  return (
    <View style={styles.container}>
      <StatusBar barStyle="dark-content" translucent={true} backgroundColor="#f1f1f1" />
      <Text style={styles.header}>Indicação de Carros</Text>
      <View style={styles.form}>
        <Text style={styles.label}>Informe suas preferências:</Text>
        <TextInput
          placeholder="Tipo de carros:"
          style={styles.input}
        />
        <TextInput
      ...
      <TouchableOpacity style={styles.button}>
        <Text style={styles.buttonText}>Gerar Indicação</Text>
      ...
      <ScrollView style={styles.containerScroll} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24, marginTop: 4 }}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Te indicamos:</Text>
        </View>
      </ScrollView>
    </View>
  );
